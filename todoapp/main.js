...
const audioselect = new Audio("key-up.mp3");
const audcomplete = new Audio("complete.mp3");
const audincomplete = new Audio("incomplete.mp3")
const auddelete = new Audio("delete.mp3")
const audcreate = new Audio("create.mp3")
